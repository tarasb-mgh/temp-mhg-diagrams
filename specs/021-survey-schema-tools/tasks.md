...
- [X] T045 [P] Update Confluence Release Notes with production release entry (version, date, user-visible changes) — ONLY when promoting to production via tagged `main` commit; skip when merging to `develop`
